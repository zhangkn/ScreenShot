...
//    [stringAttributes setObject:[UIFont fontWithName:@"Arial-BoldMT" size:18] forKey: NSFontAttributeName];
    ...
    [@"画圆：" drawInRect:CGRectMake(10, 20, 80, 20) withAttributes:stringAttributes];
    
    [@"画线及孤线：" drawInRect:CGRectMake(10, 80, 100, 20) withAttributes:stringAttributes];
    [@"画矩形：" drawInRect:CGRectMake(10, 120, 80, 20) withAttributes:stringAttributes];

    [@"画扇形和椭圆：" drawInRect:CGRectMake(10, 160, 110, 20) withAttributes:stringAttributes];

    [@"画三角形：" drawInRect:CGRectMake(10, 220, 80, 20) withAttributes:stringAttributes];

    [@"画圆角矩形：" drawInRect:CGRectMake(10, 260, 100, 20) withAttributes:stringAttributes];

    [@"画贝塞尔曲线：" drawInRect:CGRectMake(10, 300, 100, 20) withAttributes:stringAttributes];

    [@"图片：" drawInRect:CGRectMake(10, 340+80, 80, 20) withAttributes:stringAttributes];
...
//    CGContextSetRGBStrokeColor(context,0,0,0,1.0);//画笔线的颜色
    ...
    //2、签名笔划颜色
    CGFloat red = 0.0, green = 0.0, blue = 0.0;//默认blackColor
...
//    CGContextSetRGBStrokeColor(context,1,1,1,1.0);//画笔线的颜色
    ...
    [self setup_upside_down_Image:context];
...
/**
 图片上下颠倒
 */
- (void)setup_upside_down_Image:(CGContextRef )context{
